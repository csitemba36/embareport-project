...
if (isset($_GET['noRequest'])) {
    ...
    if ($result) {
        ...
        echo '<div class="mb-2">';
        //echo '<a href="http://myemba.co:83/epos/printlb/index.php?param1=' . urlencode($ParentTransaction) . '&param2=' . urlencode($param2) . '" target="_blank" class="btn btn-warning btn-sm">Cetak Label</a>';
        echo '</div>';
