...
if (!$result || $result->num_rows == 0) {
    die("Tidak ada artikel untuk brand EMBA DENIM di tabel jubelio_inventory.");
}
...
echo "\n🎯 Selesai sync brand EMBA DENIM. Inserted: $countInsert | Updated: $countUpdate\n";
