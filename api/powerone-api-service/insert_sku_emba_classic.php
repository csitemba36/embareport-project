...
if (!$result || $result->num_rows == 0) {
    die("Tidak ada artikel untuk brand EMBA CASUAL di tabel jubelio_inventory.");
}
...
echo "\n🎯 Selesai sync brand EMBA CASUAL. Inserted: $countInsert | Updated: $countUpdate\n";
