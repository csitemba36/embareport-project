...
if (!$result || $result->num_rows == 0) {
    die("Tidak ada artikel untuk brand EMBA LADIES di tabel jubelio_inventory.");
}
...
echo "\n🎯 Selesai sync brand EMBA LADIES. Inserted: $countInsert | Updated: $countUpdate\n";
