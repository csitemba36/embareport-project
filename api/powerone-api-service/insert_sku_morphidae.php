...
if (!$result || $result->num_rows == 0) {
    die("Tidak ada artikel untuk brand MORPHIDAE di tabel jubelio_inventory.");
}
...
echo "\n🎯 Selesai sync brand MORPHIDAE. Inserted: $countInsert | Updated: $countUpdate\n";
